 ...
 * Plugin URI: https://github.com/bradyvercher/wp-quick-plugin-installer
...
function qpi_install_plugin() {
	...
	require_once( plugin_dir_path( __FILE__ ) . '/class-qpi-upgrader-skin.php' );
	...
	if ( apply_filters( 'qpi_install_and_activate', false ) ) {
